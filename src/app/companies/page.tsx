    ...
    >
      ...
      */}
      {/*
        ...
        Аномалиями/темой, счётчик, полоса фильтров на всю ширину), на любой
        ширине экрана, а не только на узкой. Раньше widescreen укладывал
        заголовок слева и Filters справа в один ряд через flex-wrap +
        justify-between, и только на узких экранах это переносилось в
        столбик - теперь это единственная раскладка, gap-5 между тремя
        строками ровный на любой ширине, никакого отдельного брейкпоинта для
        переноса не нужно. min-h-[var(--chrome-bar-height)] с шапки убран -
        та переменная была калибрована под высоту шапки именно в её
        однострочном, широкоэкранном состоянии, чтобы совпасть с высотой
