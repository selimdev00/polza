...
// Тот же ARIA-listbox, что и в city-select.tsx - паттерн скопирован
// намеренно, а не вынесен в общий компонент: оба списка независимо читаемы
// и правятся, и ни один не рискует сломать другой при будущей правке одного
// из них. Отличия от city-select.tsx - только предметная область (категории
// вместо городов) и подписи.
...
export function CategorySelect({
  ...
  const selectedLabel = selectedIndex >= 0 ? options[selectedIndex].label : ALL_CATEGORIES_LABEL;
