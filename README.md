...
комбинация `q`/`city`/`page` (и без аргументов - для справочника городов и
журнала аномалий), так что у каждой комбинации фильтров свой собственный,
не пересекающийся с другими кэш.
